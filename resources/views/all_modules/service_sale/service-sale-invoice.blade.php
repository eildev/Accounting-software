            ...
            <div class="card border-0 shadow-none invoice_bg">
                <div class="card-body ">
                    <div class="container-fluid d-flex justify-content-between">
                        ...
                        <div class="col-lg-3 pe-0 text-end">
                            ...
                            <h4 class="text-end fw-normal text-success">৳ {{ $sale->total ?? 00.0 }}</h4>
                            ...
                            <table class="table table-bordered invoice_table_bg">
                                ...
                                <tbody>
                                    <tr class="text-end">
                                        ...
                                        <td class="text-start">{{ $sale->name ?? '' }}</td>
                                        <td>{{ $sale->price ?? 0 }}</td>
                                        <td>{{ $sale->volume ?? 0 }}</td>
                                        <td>{{ $sale->total ?? 0 }}</td>
                                    </tr>
                ...
                <div class="footer_invoice text-center">
                    <p>© 2024 <a href="https://eclipseintellitech.com/" target="_blank">Eclipse Intellitech
                        ...
                        reserved. Powered by Eclipse Intellitech <a href="https://accountant.eclipseintellitech.com"
                            target="_blank">Accountant</a> Software</p>
                </div>
            </div>
