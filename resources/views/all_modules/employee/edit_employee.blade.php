                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div class="mb-3 form-valid-groups">
                                    ...
                                    <input type="integer"  value="{{ $employees->phone }}" name="phone" min="0" max="9999999999999" class="form-control" placeholder="Enter Employee Number"  oninput="if(this.value.length > 13) this.value = this.value.slice(0, 13)">
                                </div>
                            </div>
                            <div class="col-sm-6 ">
                                <div class="mb-3 form-valid-groups">
                            ...
                            <div class="col-sm-6 ">
                                <div class="mb-3 form-valid-groups">
                                    ...
                                    <input type="number"  class="form-control" name="nid" value="{{ $employees->nid }}" min="0" max="9999999999999" placeholder="Enter NID Number" oninput="if(this.value.length > 13) this.value = this.value.slice(0, 13)">
                                </div>
                            </div><!-- Col -->
                            <div class="col-sm-6 ">
                                <div class="mb-3 form-valid-groups">
