...
@section('admin')
    ...
    <!-------------------------Bonus End----------------------------->
    <!-------------------------Salary Sheet----------------------------->
    <div class="row bg-white" style="margin: 0px 0px 20px 0px">
    ...
    <div class="row">
        <div class=" col-md-7 col-lg-7  col-12 grid-margin primary-color-text stretch-card">
            <div class="card ">
                <div class="card-body secondary-color">
                    ...
                    <div class="d-flex gap-2 justify-content-around mt-3 mb-1 secondary-color">
                        <div class="card-body rounded-3  bg-white " id="transportationClick">
                            <div class="d-flex align-items-center justify-content-between  mb-3">
                                <span class="primary-color-text"><img
                            ...
                            <h6 class="mb-2 ">Movement Costs </h6>
                            <h4 id="movementCost">{{ $data['movementCostSum'] }}</h4>
                        </div>

                        <div class="card-body rounded-3 bg-white " id="overNightClick">
                            <div class="d-flex justify-content-between align-items-center  mb-3">
                        ...
                        <div class="card-body bg-white rounded-3 " id="foodClick">
                            <div class="d-flex justify-content-between align-items-center   mb-3">
        ...
        <div class=" col-md-5 col-lg-5 col-12 primary-color-text">
            <div class="card">
                <div class="card-body secondary-color">
                    <div class="d-flex justify-content-between ">
                        <h4 class="text-black" >Conveyance Payment Status</h4>
                    </div>
