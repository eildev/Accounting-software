                ...
                <div class="modal-body">
                    <form id="signupForm" class="salaryStructuresForm row">
                        <div class="mb-3 col-md-6">
                            ...
                            <select class="js-example-basic-single2 form-control employee_id" name="employee_id" onkeyup="errorRemove(this);" onblur="errorRemove(this);">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="name" class="form-label">Basic Salary<span
                                    class="text-danger">*</span></label>
                            <input id="defaultconfig" class="form-control basic_salary_name" maxlength="10" name="base_salary"
                                type="number" onkeyup="errorRemove(this);" onblur="errorRemove(this);">
                            <span class="text-danger basic_salary_name_error"></span>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="name" class="form-label">House Rent<span
                                    class="text-danger">*</span></label>
                            <input id="defaultconfig" class="form-control house_rent" maxlength="10" name="house_rent"
                                type="number" onkeyup="errorRemove(this);" onblur="errorRemove(this);">
                            <span class="text-danger house_rent_error"></span>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="name3" class="form-label">Transport Allowance<span
                                    class="text-danger">*</span></label>
                            <input id="defaultconfig2" class="form-control transport_allowance" maxlength="10" name="transport_allowance"
                                type="number" onkeyup="errorRemove(this);" onblur="errorRemove(this);">
                            <span class="text-danger transport_allowance_error"></span>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="name3" class="form-label">Other Fixed Allowance<span
                                    class="text-danger">*</span></label>
                            <input id="defaultconfig3" class="form-control other_fixed_allowances" maxlength="10" name="other_fixed_allowances"
                                type="number" onkeyup="errorRemove(this);" onblur="errorRemove(this);">
                            <span class="text-danger other_fixed_allowances_error"></span>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="name4" class="form-label">Fixed Deductions<span
                                    class="text-danger">*</span></label>
                            <input id="defaultconfig5" class="form-control deductions"  maxlength="10" name="deductions"
                                type="number" onkeyup="errorRemove(this);" onblur="errorRemove(this);">
                    ...
                    <form id="signupForm" class="editSalaryStructureForm row">
                        ...
                        <div class="mb-3 col-md-6">
                            <label for="name3" class="form-label">Transport Allowance<span
                                    class="text-danger">*</span></label>
                            <input id="defaultconfig2" class="form-control transport_allowance" maxlength="10" name="transport_allowance"
                                type="number" onkeyup="errorRemove(this);" value="0" onblur="errorRemove(this);">
                            <span class="text-danger transport_allowance_error"></span>
                        </div>
                        <div class="mb-3 col-md-6">
                            <label for="name3" class="form-label">Other Fixed Allowance<span
                        ...
                        success: function(res) {
                            if (res.status == 200) {
                                ...
                                if (res.error.transport_allowance) {
                                    showError('.transport_allowance', res.error.transport_allowance);
                                }
                                if (res.error.other_fixed_allowances) {
                                    showError('.other_fixed_allowances', res.error.other_fixed_allowances);
                                }
