            ...
            <div className="sidebar-menu-area">
                <ul className="sidebar-menu" id="sidebar-menu">
                    ...
                    <li className="dropdown">
                        ...
                        <ul className="sidebar-submenu">
                            <li>
                                <NavLink to="/add-product" className={(navData) =>
                                    navData.isActive ? "active-page" : ""
                                }>
                                    <Icon
                                        icon="fa:plus-circle"
                            ...
                            <li>
                                <NavLink to="/manage-product" className={(navData) =>
                                    navData.isActive ? "active-page" : ""
                                }>
                                    <Icon
                                        icon="fa:cogs"
                            ...
                            <li>
                                <NavLink to="/subcategory" className={(navData) =>
                                    navData.isActive ? "active-page" : ""
                                }>
                                   <Icon
                            ...
                            <li>
                                <NavLink to="/brand" className={(navData) =>
                                    navData.isActive ? "active-page" : ""
                                }>
                                    <Icon
                                        icon="fa:tag"
                            ...
                            <li>
                                <NavLink to="/unit" className={(navData) =>
                                    navData.isActive ? "active-page" : ""
                                }>
                                   <Icon
                            ...
                            <li>
                                <NavLink to="/size" className={(navData) =>
                                    navData.isActive ? "active-page" : ""
                                }>
                                     <Icon
                                        icon="mdi:resize"
                    ...
                    <li>
                        <NavLink to="/supplier" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/primary-ledger" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/ledger" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/sub-ledger" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/bank" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/loan-management" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/conveyance-bill" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/conveyance-report" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/salary-sheet" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/asset-management" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/asset-revaluation" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/expense/view" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/service-sale" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/service/sale/view" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/departments" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/employee" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="/salary/structure" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
                    ...
                    <li>
                        <NavLink to="employee/bonus" className={(navData) =>
                            navData.isActive ? "active-page" : ""
                        }>
