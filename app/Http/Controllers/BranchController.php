...
class BranchController extends Controller
{
    ...
    public function  index()
    {
        ...
        return view('all_modules.branches.index');
    } //
    ...
    public function BranchView()
    {
        ...
        return view('all_modules.branches.all_branches', compact('branches'));
    } //End Method
    public function BranchEdit($id)
    {
        // $branch = $this->branchrepo->editBranch();
        $branch = Branch::findOrFail($id);
        return view('all_modules.branches.edit-branch', compact('branch'));
    } //End Method
