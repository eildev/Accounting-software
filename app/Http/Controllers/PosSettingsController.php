...
class PosSettingsController extends Controller
{
   public function PosSettingsAdd(Request $request)
   {
      ...
      return view('all_modules.pos_settings.add_pos_settings', compact('allData'));
   } //
   ...
   {
      return view('all_modules.pos_settings.invoice1');
   }
   public function PosSettingsInvoice2()
   {
      return view('all_modules.pos_settings.invoice2');
   }
   public function PosSettingsInvoice3()
   {
      return view('all_modules.pos_settings.invoice3');
   }
   public function PosSettingsInvoice4()
   {
      return view('all_modules.pos_settings.invoice4');
   }
}
